            ...
            <div class="flex">
                ...
                <li class="dropdown dropdown-notification nav-item dropdown-notifications">
                            <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                                ...
                                <span
                                    class="badge badge-pill badge-default badge-danger badge-up badge-glow notif-count"
                                    data-count="9">9</span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                <li class="dropdown-menu-header">
                                    <h6 class="m-0 text-center dropdown-header">
                                        <span class="text-center grey darken-2"> الرسائل</span>
                                    </h6>
                                </li>
                                    ...
                                    <a href="">
                                        <div class="media">
                                            <div class="media-body">
                                                <h6 class="text-right media-heading ">عنوان الاشعار </h6>
                                                <p class="text-right notification-text font-small-3 text-muted"> نص الاشعار</p>
                                ...
                                <li class="dropdown-menu-footer">
                                    </li><a class="text-center dropdown-item text-muted" href=""> جميع الاشعارات </a>
                                </li>
                            </ul>
                        </li>
            <!-- Settings Dropdown -->
